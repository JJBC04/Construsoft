...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <a class="navbar-brand" href="#">Construsoft</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="ControladorMaterial?accion=Listar" target="miContenedor">Materiales</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="Controlador?menu=" target="miContenedor">Presupuesto</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="Controlador?menu=Usuario&accion=Listar" target="miContenedor">Usuarios</a>
                    </li>
                </ul>
                <div class="btn-group">
