...
@WebServlet(name = "MaterialGalon", urlPatterns = {"/MaterialGalon"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            try {
                ...
                ps = con.prepareStatement("SELECT * FROM tblmaterial_usuario WHERE unidad_medida = 'Galon'");
                rs = ps.executeQuery();
                ...
                if (con != null) {
                    try {
                        ...
                        par1.add(new Phrase("Reporte #1 Construsoft", fonttitulo));
                        ...
                        par2.add(new Phrase("Reporte sobre los materiales de los usuarios con unidad de medida Galón.", fontdescrip));
                        ...
                        PdfPCell celda4 = new PdfPCell(new Paragraph("Unidad Medida", FontFactory.getFont("Arial", 12, Font.BOLD, BaseColor.BLACK)));
